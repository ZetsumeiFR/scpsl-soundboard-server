...
import { createSound, deleteSound, renameSound, getUserSounds, getUserSoundCount, getSoundById, getSoundFilePath, } from "../services/soundService.js";
...
router.post("/", requireUploadRateLimit, uploadSound, handleMulterError, async (req, res) => {
    try {
        const user = req.user;
        const file = req.file;
