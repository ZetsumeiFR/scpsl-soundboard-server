...
export async function updateUserAdmin(userId, isAdmin, adminUserId) {
...
export async function updateUserBanned(userId, isBanned, adminUserId) {
    // Prevent self-modification
    if (userId === adminUserId) {
        return {
            success: false,
...
export async function deleteUserWithSounds(userId, adminUserId) {
...
export async function deleteAnySound(soundId) {
