...
import { DEFAULT_SETTINGS, settingsSchema, partialSettingsSchema, } from "../schemas/settings.js";
...
export async function updateSettings(partial) {
    ...
    try {
        ...
        const updates = Object.entries(validation.data);
...
async function cacheSettings(settings) {
    try {
        const redis = await getRedisClient();
        await redis.setEx(SETTINGS_CACHE_KEY, SETTINGS_TTL_SECONDS, JSON.stringify(settings));
    }
    catch (error) {
